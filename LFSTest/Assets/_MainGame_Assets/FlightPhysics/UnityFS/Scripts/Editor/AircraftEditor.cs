...
public class AircraftEditor : InputEditor 
{
	...
	{
		string source = Application.dataPath + "/FlightPhysics/UnityFS/Data/";
		string dest = Application.dataPath + "/FlightPhysics/Gizmos/";
	...
	{ 
		if ( !FetchVersion )
		{
			string autoupdatePath = Application.dataPath + "/FlightPhysics/UnityFS/Data/" + "autoupdate.dat";
