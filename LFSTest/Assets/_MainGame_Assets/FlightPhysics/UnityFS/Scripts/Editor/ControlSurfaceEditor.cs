...
public class ControlSurfaceEditor : InputEditor 
{
	...
	public override void OnInspectorGUI() 
	{
		...
		if ( ParametersFoldOut )
		{
			...
			targetControlSurface.Is_Vertical = EditorGUILayout.Toggle( "Is Vertical", targetControlSurface.Is_Vertical );
			targetControlSurface.Is_Horizontal = EditorGUILayout.Toggle( "Is Horizontal", targetControlSurface.Is_Horizontal );
			targetControlSurface.Is_Daigonal = EditorGUILayout.Toggle( "Is Is_Daigonal", targetControlSurface.Is_Daigonal );
			targetControlSurface.PlaneModel = EditorGUILayout.ObjectField("PlaneModel", targetControlSurface.PlaneModel, typeof(UnityEngine.GameObject), true) as UnityEngine.GameObject;
		}
		
		EditorGUILayout.Space();
		
		VisualsFoldOut = EditorGUILayout.Foldout( VisualsFoldOut, "VisualsNew" );
		if ( VisualsFoldOut )
		{
